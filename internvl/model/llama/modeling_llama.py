...
from internvl.model.attention_layer_utils import attention_layer_in_range
...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def forward(
        ...
        attention_layer_range: Optional[Tuple[int, int]] = None,
        ...
        for idx, decoder_layer in enumerate(self.layers):
            ...
            if output_attentions and attention_layer_in_range(idx, attention_layer_range, len(self.layers)):
...
class LlamaForCausalLM(LlamaPreTrainedModel):
    ...
    def forward(
        ...
        outputs = self.model(
            ...
            attention_layer_range=attention_layer_range,
        ...
        model_inputs.update(
            {
                ...
                'attention_layer_range': kwargs.get('attention_layer_range'),
